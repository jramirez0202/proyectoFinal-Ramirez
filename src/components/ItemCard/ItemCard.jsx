        ...
        <figure>
          ...
          />
				...
				<div className="mt-2.5 mb-5 ml-5">
					<span className="text-xl font-bold text-gray-900 dark:text-white"> {t('itemCard.card.price')} ${price}</span>
          <br />
          <span className="text-xl font-bold text-gray-900 dark:text-white"> {t('itemCard.card.category')} {t(`itemCard.card.categoryName.c${id}`) || category}</span>
